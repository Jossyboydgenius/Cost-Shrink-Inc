      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-700 max-w-3xl mx-auto font-medium leading-relaxed">
            At Cost Shrink Inc., we believe that every dollar counts—especially
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed font-medium">
                Our mission is simple: to help you reduce costs to the barest
                minimum without compromising quality, so you can focus on
            ...
            <div className="bg-gradient-to-r from-gray-50 to-blue-50/50 p-8 rounded-2xl border border-gray-100">
              <p className="text-gray-800 leading-relaxed italic text-xl font-medium">
                &ldquo;We don&apos;t just crunch numbers. We partner with you to
                uncover opportunities, improve efficiency, and protect your
                bottom line. Whether you&apos;re a sole proprietor or managing a
                growing small business, we provide practical solutions tailored
                to your unique needs.&rdquo;
              </p>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-[#29587A] to-[#1e3f5a] rounded-2xl p-8 lg:p-12 text-white mb-16">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
            <div className="lg:col-span-2 space-y-4">
              <h3 className="text-3xl font-bold">Expert Leadership</h3>
              <p className="text-blue-100 leading-relaxed font-medium text-lg">
                With over 13 years of hands-on cost control experience, our
                founder—a certified public accountant—brings proven expertise in
                identifying hidden savings, streamlining financial operations,
                and guiding businesses toward smarter, more sustainable
                financial practices.
              </p>
            ...
            <div className="text-center lg:text-right">
              <div className="inline-block bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 group">
                <div className="mb-2 group-hover:scale-110 transition-transform duration-300 text-center">
                  <Image
                    src="/cpa-logo.png"
                    alt="CPA Logo"
                    width={220}
        ...
        <div className="text-center mt-16">
          ...
          <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto font-medium leading-relaxed">
            Ready to transform your business finances? Let&apos;s work together
            to uncover savings and drive growth.
          </p>
