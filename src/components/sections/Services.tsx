...
import { BarChart3, FileText, Lightbulb, Search, Zap, Target, ArrowRight, Sparkles } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-6xl font-bold text-gray-900 mb-8">
            Our <span className="bg-gradient-to-r from-[#29587A] to-[#1e3f5a] bg-clip-text text-transparent">Services</span>
          </h2>
          <p className="text-lg text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium">
            We provide small businesses and sole proprietors with practical financial solutions that reduce expenses and strengthen profitability. Every service is designed to help you stay compliant, efficient, and cost-effective.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative h-52 overflow-hidden">
                  ...
                  />
                  <div className={`absolute inset-0 bg-gradient-to-br ${service.color}/20 group-hover:${service.color}/40 transition-all duration-500`}></div>
                  <div className={`absolute top-6 left-6 ${service.bgColor} rounded-2xl p-4 shadow-xl group-hover:scale-110 transition-transform duration-300`}>
          ...
          <div className="bg-gradient-to-br from-[#29587A] via-[#1e3f5a] to-[#0f2027] rounded-3xl p-12 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h3 className="text-5xl font-bold mb-8">
                Ready to Start <span className="bg-gradient-to-r from-blue-200 to-cyan-200 bg-clip-text text-transparent">Saving?</span>
              </h3>
              <p className="text-blue-100 mb-10 max-w-3xl mx-auto text-xl leading-relaxed font-medium">
                Let us help you identify cost-saving opportunities and implement strategies that will boost your bottom line.
              </p>
              <Link href="/consultation" className="group bg-white text-[#29587A] px-12 py-5 rounded-full font-bold text-xl hover:bg-blue-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center mx-auto">
