...
const servicesData: Record<string, ServiceData> = {
  bookkeeping: {
    ...
    longDescription:
      "Our comprehensive bookkeeping services ensure your financial records are accurate, up-to-date, and compliant with all regulations. We handle everything from daily transaction recording to monthly reconciliations, giving you complete visibility into your business finances.",
    features: [
  ...
  "tax-filing": {
    ...
    longDescription:
      "Our expert tax filing services take the stress out of tax season. We ensure maximum deductions, minimize your tax liability, and handle all the paperwork so you can focus on your business.",
    features: [
  ...
  "tax-consulting": {
    ...
    longDescription:
      "Our strategic tax consulting goes beyond basic compliance. We develop comprehensive tax strategies that minimize your long-term tax burden while ensuring full compliance with all regulations.",
    features: [
  ...
  "cost-monitoring": {
    ...
    longDescription:
      "Our advanced cost monitoring systems provide real-time visibility into your business expenses, helping you identify trends, spot anomalies, and uncover opportunities for savings.",
    features: [
  ...
  "cost-control": {
    ...
    longDescription:
      "Our cost control strategies help you implement systematic approaches to reduce unnecessary expenses while maintaining operational efficiency and quality standards.",
    features: [
  ...
  "cost-management": {
    ...
    longDescription:
      "Our comprehensive cost management approach balances cost reduction with strategic investment, ensuring your resources are allocated to drive maximum business growth and profitability.",
    features: [
      ...
      <section className="py-20 bg-gradient-to-br from-[#29587A] via-[#1e3f5a] to-[#0f2027]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 leading-relaxed">
            ...
            business finances with our expert {service.title.toLowerCase()}{" "}
            services.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="border-2 border-white text-white px-8 py-4 rounded-full font-semibold hover:bg-white hover:text-[#29587A] transition-all duration-300"
            >
              Call (555) 123-4567
            </a>
          </div>
