          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            ...
            <div className="mb-12">
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-6">
                ...
                binding agreement between you and Cost Shrink Inc
                (&quot;Company,&quot; &quot;we,&quot; &quot;our,&quot; or
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Cost Shrink Inc provides financial consulting and cost reduction
                services to businesses, including but not limited to:
              </p>
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                ...
                services are owned by Cost Shrink Inc and are protected by
            ...
            <div className="mb-12">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-yellow-700 leading-relaxed">
                      The information and services provided by Cost Shrink Inc
                      are for general informational purposes only and do not
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
                ...
                <li>
                  You should consult with qualified professionals for specific
                  advice
                </li>
                <li>
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                To the fullest extent permitted by applicable law, Cost Shrink
              ...
              <p className="text-gray-600 leading-relaxed mt-4">
                ...
                our services in the twelve months preceding the claim.
              </p>
            </div>
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                immediately, and any provisions of these Terms that should
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                with the laws of [Your State/Province], without regard to its
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                force and effect, and the invalid provision will be replaced
                with a valid provision that most closely reflects the intent of
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                entire agreement between you and Cost Shrink Inc regarding your
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="space-y-3 text-gray-600">
                <p>
                  <strong>Cost Shrink Inc</strong>
                </p>
                <p>
                  Email:{" "}
                  <a
                    href="mailto:legal@costshrink.ca"
...
export function generateMetadata() {
  return {
    ...
    description:
      "Read the terms and conditions for using Cost Shrink Inc services. Understand your rights and responsibilities when using our financial consulting services.",
    keywords:
      "terms of service, terms and conditions, legal agreement, cost shrink inc",
  };
}
