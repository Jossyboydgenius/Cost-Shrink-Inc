            ...
            <div className="mb-12">
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
                ...
                <li>
                  ...
                  your personal information in a structured format
                </li>
              </ul>
              <p className="text-gray-600 leading-relaxed mt-4">
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="space-y-3 text-gray-600">
                ...
                <p>
                  Email:{" "}
                  <a
                    href="mailto:privacy@costshrink.ca"
                    className="text-[#29587A] hover:text-[#1e3f5a] font-medium"
                  >
                    privacy@costshrink.ca
                  </a>
                </p>
                <p>
                  Phone:{" "}
...
export function generateMetadata() {
  return {
    ...
    description:
      "Learn how Cost Shrink Inc collects, uses, and protects your personal information. Our comprehensive privacy policy explains our data practices and your rights.",
    keywords:
      "privacy policy, data protection, personal information, cost shrink inc",
  };
}
